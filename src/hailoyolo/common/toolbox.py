...
def init_input_source(input_path, batch_size, resolution, camera_index=0):
    """
    ...
    Args:
        ...
        camera_index: index of webcam (only used if input_path == "camera")
    ...
    if input_path == "camera":
        ...
        if not is_valid_camera_index(camera_index):
            logger.error(f"camera index {camera_index} not found.")
